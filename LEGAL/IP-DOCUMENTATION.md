...
### Phase 1: Conceptual Development (December 2024 - February 2025)

- Identified gap in security awareness training market
- Recognized that existing training focuses on technical indicators while ignoring psychological manipulation mechanisms
- Developed initial concept: applying IOC (Indicator of Compromise) framework to emotional/psychological states
- Created first draft of EIOC taxonomy mapping emotional vulnerabilities to technical exploit categories
- Documented in personal development notes and working documents

### Phase 2: Framework Development (March 2025 - June 2025)

- Refined five-category EIOC classification system:
  - Prestige Mirage (Status-Based Exploit)
  - Familiarity Shortcut (Implicit Trust Injection)
  - Performance Reflex (Urgency Trigger Exploit)
  - Empathic Camouflage (Affinity Bias Pretexting)
  - Deference Drift (Authority Spoof Lever)
- Developed Stewardship Cues™ defensive methodology
...
- Prepared documentation for commercial deployment
...
2. **"Cybersecurity Psalms for Children"** — Amazon KDP
   - Demonstrates author's methodology for emotional/psychological approach to security education
...
The creator has also developed complementary frameworks that inform the EIOC methodology:

- **Myth-Tech Framework** — Mapping mythological archetypes to modern security threats
- **Care-based security pedagogy** — Security as stewardship rather than control
- **Emotional Intelligence in Security** — Integration of EQ principles with technical security

---

## Trademark Claims

The following marks are claimed as trademarks of SoftArmorLabs:
...
The following elements are designated as trade secrets under the Defend Trade Secrets Act (DTSA) and Texas Uniform Trade Secrets Act:

1. **Scoring Algorithms**
   - Vulnerability calculation methodologies
   - Readiness level determination formulas
   - Recommendation generation logic

2. **Assessment Design**
   - Specific question formulations
   - Scenario constructions
   - Response option architectures

3. **Technical Mappings**
   - Specific correlations between emotional states and attack vectors
   - Classification criteria for EIOC categories
   - Stewardship Cue development methodology

---

## Copyright Registration

Copyright protection attaches automatically upon creation. Formal registration with the U.S. Copyright Office may be pursued for enhanced enforcement rights.

**Works Eligible for Registration:**
- Source code (HTML, CSS, JavaScript)
- Written documentation and framework descriptions
- Assessment content and scenarios
